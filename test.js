...
var withObjectKeys = require( './test-runners/withObjectKeys' );
var withArrayIndexof = require( './test-runners/withArrayIndexof' );
...
function runTest( payload ) {
	...
	suite.add( 'array.indexOf', function () {
		withArrayIndexof( payload );
	})
	.add( 'object.keys', function () {
		withObjectKeys( payload );
	})
